Huffman.h: estão presente os protótipos das funções utilizadas para fazer criação da árvore, codificação e decodificação (serialização está presente no encode.c, e
